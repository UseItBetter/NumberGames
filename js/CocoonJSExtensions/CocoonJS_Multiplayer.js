(function()
{
	...
	*/
	CocoonJS.Multiplayer.MatchManager = function(nativeExtensionName, extensionName, matchManagerID)
	{
	   ...
	   /**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchFound} event calls.
	    * @name OnMatchFoundListener
	    * @function
	    * @static
	    ...
	    */
	    ...
	    this.onMatchFound.addEventListener(function(matchManager, match) {
	   	...
	   	/**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchRequestCanceled} event calls.
	    * @name OnMatchRequestCanceledListener
	    * @function
	    * @static
	    ...
	    */
	    this.onMatchRequestCanceled = new CocoonJS.EventHandler(this.nativeExtensionName, this.extensionName, "onMatchRequestCanceled", function(sourceListener, args)
	   	...
	   	/**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchRequestFailed} event calls.
	    * @name OnMatchRequestFailedListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Social
	   	* @param {CocoonJS.Multiplayer.MatchManager} match The source match manager
	    ...
	    */
	    ...
	    /**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onInvitationReceived} event calls.
	    * @name OnInvitationReceivedListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Social
	   	* @param {CocoonJS.Multiplayer.MatchManager} match The source match manager
	    ...
	    */
	    this.onInvitationReceived = new CocoonJS.EventHandler(this.nativeExtensionName, this.extensionName, "onInvitationReceived", function(sourceListener, args)
	   	...
	   	/**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchPlayerAdditionSucceeded} event calls.
	    * @name OnMatchPlayerAdditionSucceededListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Social
	   	* @param {CocoonJS.Multiplayer.MatchManager} match The source match manager
	    ...
	    */
	    this.onMatchPlayerAdditionSucceeded = new CocoonJS.EventHandler(this.nativeExtensionName, this.extensionName, "onMatchPlayerAdditionSucceeded", function(sourceListener, args)
	   	...
	   	/**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchPlayerAdditionFailed} event calls.
	    * @name OnMatchPlayerAdditionFailedListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Social
	   	* @param {CocoonJS.Multiplayer.MatchManager} match The source match manager
	...
	*/
	CocoonJS.Multiplayer.Match = function(nativeExtensionName, extensionName, matchID)
	{
	   ...
	   /**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchDataReceived} event calls.
	    * @name OnMatchDataReceivedListener
	    * @function
	    * @static
	    ...
	    */
	    ...
	    /**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchStateChanged} event calls.
	    * @name OnMatchStateChangedListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Multiplayer.Match
	    * @param {CocoonJS.Multiplayer.Match} match The source match.
	    ...
	    */
	    ...
	    /**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchConnectionWithPlayerFailed} event calls.
	    * @name OnMatchConnectionWithPlayerFailedListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Multiplayer.Match
	    * @param {CocoonJS.Multiplayer.Match} match The source match.
	    ...
	    */
	    ...
	    /**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchFailed} event calls.
	    * @name OnMatchFailedListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Multiplayer.Match
	    * @param {CocoonJS.Multiplayer.Match} match The source match.
	    ...
	    */
	    this.onMatchFailed = new CocoonJS.EventHandler(this.nativeExtensionName, this.extensionName, "onMatchFailed", function(sourceListener, args)
	   	...
	   	/**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchPlayersInfoRequestSuceeded} event calls.
	    * @name OnMatchPlayersInfoRequestSuceededListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Multiplayer.Match
	    * @param {CocoonJS.Multiplayer.Match} match The source match.
	    ...
	    */
	    ...
	    /**
	    * FOR DOCUMENTATION PURPOSE ONLY! The documentation of the function callback for the {@link CocoonJS.Multiplayer.onMatchPlayersInfoRequestFailed} event calls.
	    * @name OnMatchPlayersInfoRequestFailedListener
	    * @function
	    * @static
	    * @memberOf CocoonJS.Multiplayer.Match
	    * @param {CocoonJS.Multiplayer.Match} match The source match.
	...
	CocoonJS.Multiplayer.Match.prototype = {
		...
		*/
		...
		/**
		* @return The remaining number of players who have not yet connected to the match
		*/
		...
		/**
		* @return The player identifiers for the players in the match
		*/
