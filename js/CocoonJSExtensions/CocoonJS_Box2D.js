...
if ( !navigator.isCocoonJS || typeof window.ext === 'undefined' || typeof window.ext.IDTK_SRV_BOX2D === 'undefined' )
{
   console.log("ERROR: The CocoonJS binding for Box2D only works inside of CocoonJS");   
}
